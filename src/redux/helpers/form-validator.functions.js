import {checkEmail, checkPassword, checkOtp, checkName, checkDob} from "./helper_functions";
...
export function isPass(password) {
    ...
    if(password === '') {
      // setErrorFor(obj, 'Password cannot be blank');
      return false;
    }else if (!checkPassword(password)) {
      // setErrorFor(obj, 'Not a valid password');
      return false;
    }
    else {
      // setSuccessFor(obj);
...
export function isCpass(password2) {
    ...
    if(password2 === '') {
      ...
      // setErrorFor(obj, 'Passwords does not match');
      return false;
    } else{
      // setSuccessFor(obj);
      return true;
